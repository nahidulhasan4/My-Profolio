...
const FeaturedProject = ({ type, title, summmary, img, link, github }) => {
  return (
    <article className="w-full flex flex-col lg:flex-row items-center relative justify-between rounded-br-2xl rounded-3xl border border-solid bg-light p-4 sm:p-8 lg:p-12 border-dark shadow-2xl">
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-start justify-between pl-0 lg:pl-6 mt-4 lg:mt-0">
...
const Project1 = ({ title, type, img, link, github }) => {
  return (
    <article className="w-full flex flex-col items-center justify-center rounded-2xl border border-solid border-dark bg-light p-4 sm:p-6 relative">
...
const project = () => {
  return (
    <>
      {/* এই সেকশনটি Project পেজের হেড এবং মেটা ডেটা সেট করে */}
      <Head>
        <title>Nahid | Projects Page</title>
        <meta name="description" content="Generated by create next app" />
      </Head>
      {/* এই অংশে Featured Project এবং Smaller Project Card গুলো দেখানো হয় */}
      <main className="w-full mb-16 flex px-2 sm:px-6 lg:px-10 flex-col mt-4 items-center justify-center">
        <Layout className="pt-6 sm:pt-10 lg:pt-16">
          <AnimatedText
            text="Imagination Trumps Knowledge!"
            className="dark:text-light w-full !text-left text-[22px] sm:text-[28px] md:text-[32px] lg:!text-7xl lg:text-[40px]"
          />
          <div className="grid mt-5 grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-24">
