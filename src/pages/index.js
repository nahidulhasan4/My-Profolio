  ...
  return (
    <>
      ...
      <main className="mt-7 flex dark:text-light w-full min-h-screen text-dark font-mont">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between w-full gap-6 lg:gap-12 md:gap-0">
            <div className="w-full md:w-1/2">
              <Image
                src={ProfilePic}
                alt="nahio Hasan"
                className="w-full max-[400px]  h-auto"
              ></Image>
            </div>
            <div className="w-full md:w-1/2 flex flex-col items-center self-center">
              ...
              <div className="flex flex-wrap items-center self-start mt-2 gap-3 ">
        ...
        <HireMe />
        <div className="absolute right-8 bottom-[-140px] hidden md:inline-block w-24">
