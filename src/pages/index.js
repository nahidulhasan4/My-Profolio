      ...
      <main className=" mt-7 flex dark:text-light w-full min-h-screen text-dark font-mont">
        ...
        <div className="flex items-center  justify-between w-full">
          ...
          <div className="flex items-center self-start mt-2 gap-3 ">
            <Link href="/dummy.pdf" target={'_blank'} download={true} className="flex items-center bg-dark text-light p-2.5 px-6 rounded-lg text-lg font-semibold hover:text-dark dark:bg-light dark:text-dark hover:bg-light border-solid border-transparent hover:border-dark border-2">Resume   </Link>
           
            <Link href="mailto:nahidhsan4836@gmail.com" target={'_blank'} className="ml-4 text-lg font-medium underline capitalize text-dark  dark:text-light " >Email</Link>
          </div>
          </div>
        </div>
