    ...
    <>
      ...
      <main className="flex w-full flex-col items-center justify-center mt-4">
        <Layout className="pt-6 sm:pt-10 lg:pt-16 px-3 sm:px-5">
          <AnimatedText text="Passion Fules Purpose!" className="!text-4xl sm:!text-6xl lg:!text-8xl dark:text-light mb-8 sm:mb-16" />
          <div className="grid w-full grid-cols-1 lg:grid-cols-8 mb-8 gap-8 lg:gap-16">
            ...
            <div className="lg:col-span-2 flex flex-col items-center lg:items-end justify-between gap-6 lg:gap-0">
              <div className="flex flex-col items-center justify-center">
                ...
                <h2 className="text-lg sm:text-xl font-medium dark:text-light capitalize text-dark/75 text-center">Satisfied client</h2>
              </div>
              <div className="flex flex-col items-center justify-center">
                <span className="inline-block dark:text-light text-5xl sm:text-7xl font-bold">
                <AnimatedNumbers value={40}/>+
                </span>
                <h2 className="text-lg sm:text-xl dark:text-light font-medium capitalize text-dark/75 text-center">Projects Completed</h2>
              </div>
              <div className="flex flex-col dark:text-light items-center justify-center">
                ...
                <h2 className="text-lg sm:text-xl font-medium dark:text-light capitalize text-dark/75 text-center">Years of exprence</h2>
              </div>
            </div>
          </div>
