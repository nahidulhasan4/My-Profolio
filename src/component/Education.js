  ...
  return (
    <li ref={ref} className="my-8 first:mt-0 last:mb-0 w-full sm:w-[80%] lg:w-[60%] mx-auto flex flex-col items-start sm:items-center justify-between">
      ...
      >
        ...
        <p className="font-medium dark:text-light w-full text-sm sm:text-base">{info}</p>
      </motion.div>
    </li>
  );
};
...
const Education = () => {
  ...
  return (
    <div className="my-20 sm:my-32 lg:my-64">
      <h2 className="font-bold text-5xl sm:text-6xl lg:text-8xl dark:text-light mb-10 sm:mb-20 lg:mb-32 w-full text-center">Education</h2>
