  ...
  return (
    <li ref={ref} className="my-8 first:mt-0 last:mb-0 w-[60%] mx-auto flex flex-col  items-center justify-between">
      ...
      >
        ...
        <span className=" font-medium capitalize  dark:text-light text-dark/75">
          {time} {place}
        </span>
...
const Education = () => {
  ...
  return (
    <div className="my-64">
      <h2 className="font-bold text-8xl  dark:text-light mb-32 w-full text-center">Education</h2>
